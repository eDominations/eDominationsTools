...
?>
        ...
        <body>
        <?php
$player= DB::table('players')->join('mudetails','mudetails.ID','=','players.MilitaryUnitID')->select("players.Name","players.Level","players.Strength","players.CS","players.MilitaryUnitID","players.MilitaryRank","players.DMG1HIT","players.TotalDMG","players.MilitaryRank2" , "mudetails.MilitaryUnit" , "players.ID")->orderBy("players.TotalDMG" ,"DESC")->paginate(300);
?>
        ...
        <tr>
                <th colspan="10" ><h2 align="center">PLAYERS</h2></th>
                </tr>
